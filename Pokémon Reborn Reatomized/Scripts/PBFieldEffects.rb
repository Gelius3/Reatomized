FIELDEFFECTS = {
	...
	PBFields::RAINBOWF => {
		...
		:MOVEDAMAGEBOOST => {
			...
			0.5 => [PBMoves::DARKPULSE, PBMoves::SHADOWBALL, PBMoves::NIGHTDAZE, PBMoves::NEVERENDINGNIGHTMARE,
				...
				PBMoves::DRAINLIFE, PBMoves::DEATHNAIL]},
		:MOVEMESSAGES => {
	...
	PBFields::FORESTF => {
		...
		:MOVEDAMAGEBOOST => {
			...
			1.5 => [PBMoves::ATTACKORDER, PBMoves::ELECTROWEB, PBMoves::CUT, PBMoves::SKITTERSMACK, PBMoves::DRUMBEATING, PBMoves::POUNCE,
		...
		:MOVEMESSAGES => {
			...
			"The target was cut down to size!" => [PBMoves::CUT,
				PBMoves::BREAKINGSWIPE, PBMoves::VENOMSWIPE],
	...
	PBFields::WATERS => {
		...
		:MOVEMESSAGES => {
			"The attack rode the current!" => [PBMoves::SURF, PBMoves::MUDDYWATER, 
				PBMoves::WHIRLPOOL, PBMoves::DIVE, PBMoves::HYDROVORTEX, PBMoves::WAVECRASH]},
		:TYPEDAMAGEBOOST => {
	...
	PBFields::FAIRYTALEF => {
		...
		1.5 => [PBMoves::NIGHTSLASH, PBMoves::LEAFBLADE, PBMoves::PSYCHOCUT, 
						...
						PBMoves::MYSTICALFIRE, PBMoves::ANCIENTPOWER, PBMoves::RELICSONG, PBMoves::KOWTOWCLEAVE,
	...
	PBFields::NEWW => {
        ...
        "The universe is reshaped!" => [PBMoves::BIGBANG2],
