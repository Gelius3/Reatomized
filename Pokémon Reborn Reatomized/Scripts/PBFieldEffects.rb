FIELDEFFECTS = {
	...
	PBFields::ELECTRICT => {
		...
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::EXPLOSION, PBMoves::SELFDESTRUCT, PBMoves::HURRICANE, PBMoves::SURF, PBMoves::PSYBLADE,
				PBMoves::SMACKDOWN, PBMoves::MUDDYWATER, PBMoves::THOUSANDARROWS,
				PBMoves::WILDBOLTSTORM, PBMoves::AURAWHEELMINUS, PBMoves::THUNDEROUSKICK, PBMoves::SPLISHYSPLASH],
	...
	PBFields::GRASSYT => {
		...
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::FAIRYWIND, PBMoves::SILVERWIND,
				PBMoves::GRASSKNOT, PBMoves::GUST, PBMoves::ICYWIND, PBMoves::OMINOUSWIND,
				PBMoves::RAZORWIND, PBMoves::TWISTER, PBMoves::TRAILBLAZE],
		...
		:FIELDCHANGE => {
			...
			PBFields::FORESTF => [PBMoves::FORESTFRENZY]},
		...
		:CHANGEMESSAGE => {
			...
			"The grassy terrain burst into a forest!" => [PBMoves::FORESTFRENZY]},
	...
	PBFields::MISTYT => {
		...
		:MOVEDAMAGEBOOST => {
			...
			1.5 => [PBMoves::FAIRYWIND, PBMoves::MYSTICALFIRE, PBMoves::MOONBLAST, 
				...
				PBMoves::SPRINGTIDESTORM, PBMoves::NIMBUSFIST, PBMoves::FOGGYSTRIKE, PBMoves::SPARKLYSWIRL],
			0.5 => [PBMoves::DARKPULSE, PBMoves::SHADOWBALL, PBMoves::NIGHTDAZE]},
		:MOVEACCURACYBOOST => {100 => [PBMoves::SWEETKISS]},
		:MOVEMESSAGES => {
			"The mist's energy strengthened the attack!" => [PBMoves::FAIRYWIND, PBMoves::MYSTICALFIRE, 
				...
				PBMoves::SILVERWIND, PBMoves::MOONGEISTBEAM, PBMoves::MISTYEXPLOSION],
	...
	PBFields::DARKCRYSTALC => {
		...
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::DARKPULSE, PBMoves::NIGHTDAZE, PBMoves::NIGHTSLASH,
				...
				PBMoves::MENACINGMOONRAZEMAELSTROM, PBMoves::CEASELESSEDGE,
				PBMoves::DYNAMAXCANNON, PBMoves::ETERNABEAM, PBMoves::AURAWHEELMINUS, PBMoves::FIERYWRATH,
				PBMoves::LUMINACRASH, PBMoves::TWINBEAM, PBMoves::LASERPULSE, PBMoves::GEMSTONEGLIMMER,
				PBMoves::COSMICBARRAGE, PBMoves::MIDNIGHTPHOTOSYNTHESIS, PBMoves::AMBUSH, PBMoves::BLOODMOON,
				PBMoves::LIGHTOFRUIN, PBMoves::TERASTARSTORM],
			2.0 => [PBMoves::PRISMATICLASER, PBMoves::BLACKHOLEECLIPSE,
				PBMoves::WEAKENINGJUMPSCARE],
		...
		:MOVEMESSAGES => {
			...
			"The darkness strengthened the attack!"	=> [PBMoves::SHADOWBALL, PBMoves::SHADOWPUNCH, 
				...
				PBMoves::MENACINGMOONRAZEMAELSTROM, PBMoves::CEASELESSEDGE,
				PBMoves::AURAWHEELMINUS, PBMoves::FIERYWRATH, PBMoves::WEAKENINGJUMPSCARE, PBMoves::AMBUSH], 
			"The crystals' light strengthened the attack!" =>	[PBMoves::AURORABEAM, 
				...
				PBMoves::DYNAMAXCANNON, PBMoves::ETERNABEAM, PBMoves::LUMINACRASH, PBMoves::TWINBEAM,
				PBMoves::GEMSTONEGLIMMER, PBMoves::COSMICBARRAGE, PBMoves::MIDNIGHTPHOTOSYNTHESIS, PBMoves::LIGHTOFRUIN,
				PBMoves::TERASTARSTORM],
			"The blood red moon shone brightly!" => [PBMoves::BLOODMOON],
		...
		:MOVETYPEMOD => {PBTypes::DARK => [PBMoves::LASERPULSE]},
		:FIELDCHANGE => {
			PBFields::CAVE => PBFields::QUAKEMOVES + [PBMoves::TIDYUP],
		...
		:CHANGEMESSAGE => {
			...
			"The dark crystals were swept up!" => [PBMoves::TIDYUP]},
	...
	PBFields::CHESSB => {
		...
		:MOVEDAMAGEBOOST => {
			1.5 => PBFields::CHESSMOVES + [PBMoves::FEINT, PBMoves::FEINTATTACK,
				PBMoves::FAKEOUT, PBMoves::SUCKERPUNCH, PBMoves::FIRSTIMPRESSION,
				PBMoves::SHADOWSNEAK, PBMoves::SMARTSTRIKE,
				PBMoves::FALSESURRENDER, PBMoves::KOWTOWCLEAVE]},
		:MOVEMESSAGES => {
			"En passant!" => [PBMoves::FEINT, PBMoves::FEINTATTACK, PBMoves::FAKEOUT,
		...
		:FIELDCHANGE => {
			0 => [PBMoves::STOMPINGTANTRUM, PBMoves::TECTONICRAGE,
				PBMoves::LASHOUT, PBMoves::OUTRAGE, PBMoves::THRASH, PBMoves::RAGINGFURY,
				PBMoves::TIDYUP, PBMoves::TEMPERFLARE]},
		:CHANGEMESSAGE => {
			"The board was destroyed!" => [PBMoves::STOMPINGTANTRUM, PBMoves::TECTONICRAGE,
				PBMoves::LASHOUT, PBMoves::OUTRAGE, PBMoves::THRASH, PBMoves::RAGINGFURY,
				PBMoves::TEMPERFLARE],
			"The board was swept away!" => [PBMoves::TIDYUP]},
	...
	PBFields::BIGTOPA => {
		...
		:MIMICRY => PBTypes::NORMAL,
		:MOVEDAMAGEBOOST => {
			1.2 => [PBMoves::TRIPLEAXEL, PBMoves::SKITTERSMACK, PBMoves::BODYPRESS],	
			1.5 => [PBMoves::VINEWHIP, PBMoves::POWERWHIP, PBMoves::FIRELASH, 
				...
				PBMoves::AURAWHEELPLUS, PBMoves::AURAWHEELMINUS, PBMoves::AQUASTEP, PBMoves::TRIPLEDIVE,
				PBMoves::ORDERUP, PBMoves::METALWHIP, PBMoves::IONICWHIPLASH, PBMoves::THORNWHIP,
				PBMoves::DRUMBEATING],
			2.0 => [PBMoves::PAYDAY, PBMoves::MAKEITRAIN,
				PBMoves::GOLDENFIST]},
		:MOVEACCURACYBOOST => {100 => [PBMoves::SING, PBMoves::TRIPLEAXEL]},
		:MOVEMESSAGES => {
			...
			"And A-One, and A-Two!" => [PBMoves::TRIPLEAXEL, PBMoves::TRIPLEKICK,
				PBMoves::TRIPLEDIVE],
			"A flattening performance!" => [PBMoves::SKITTERSMACK, PBMoves::BODYPRESS],
			"And a little extra for you, darling!" => [PBMoves::PAYDAY, PBMoves::MAKEITRAIN,
				PBMoves::GOLDENFIST],
			"Loud and clear!" => [PBMoves::DRUMBEATING]},
	...
	PBFields::BURNINGF => {
		...
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::SMOG, PBMoves::CLEARSMOG,
				PBMoves::SCORCHINGSANDS, PBMoves::FIERYWRATH, PBMoves::CINDERBREATH],
		...
		:MOVEMESSAGES => {
			"The flames spread from the attack!" => [PBMoves::SMOG, PBMoves::CLEARSMOG,
				PBMoves::CINDERBREATH],
			"{1} was knocked into the flames!" => [PBMoves::SMACKDOWN, PBMoves::THOUSANDARROWS],
			"The blaze amplified the attack!" => [PBMoves::FIERYWRATH],
			"The red hot sand got hotter!" => [PBMoves::SCORCHINGSANDS]},
		:MOVETYPEMOD => {
			PBTypes::FIRE => [PBMoves::SMACKDOWN, PBMoves::SMOG, PBMoves::CLEARSMOG, PBMoves::THOUSANDARROWS]},
		:TYPEDAMAGEBOOST => {
			1.5 => [PBTypes::FIRE],
	...
	PBFields::SWAMPF => {
		...
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::MUDBOMB, PBMoves::MUDSHOT, PBMoves::MUDSLAP, PBMoves::MUDDYWATER, 
				...
				PBMoves::SAVAGESPINOUT],
			0.5 => [PBMoves::SPINOUT, PBMoves::BLAZINGTORQUE, PBMoves::WICKEDTORQUE, PBMoves::NOXIOUSTORQUE,
				PBMoves::COMBATTORQUE, PBMoves::MAGICALTORQUE],
			0.25 => [PBMoves::EARTHQUAKE, PBMoves::MAGNITUDE, PBMoves::BULLDOZE,
				PBMoves::SUBDUCTION]},
		:MOVEACCURACYBOOST => {
			100 => [PBMoves::SLEEPPOWDER,
				PBMoves::POISONPOWDER, PBMoves::STUNSPORE]},
		:MOVEMESSAGES => {
			...
			"The attack dissipated in the soggy ground..." => [PBMoves::EARTHQUAKE, PBMoves::MAGNITUDE, PBMoves::BULLDOZE,
				PBMoves::SUBDUCTION],
			"*sputter*" => [PBMoves::SPINOUT, PBMoves::BLAZINGTORQUE, PBMoves::WICKEDTORQUE, PBMoves::NOXIOUSTORQUE,
				PBMoves::COMBATTORQUE, PBMoves::MAGICALTORQUE]},
		:MOVETYPEMOD => {PBTypes::WATER => [PBMoves::SMACKDOWN, PBMoves::THOUSANDARROWS]},
		:TYPEDAMAGEBOOST => {
			1.5 => [PBTypes::POISON],
			1.3 => [PBTypes::WATER, PBTypes::BUG, PBTypes::GRASS],
			0.8 => [PBTypes::FIRE]},
		:TYPEMESSAGES => {
			"The poison infected the nearby murk!" => [PBTypes::POISON],
			"Bugs are swarming everywhere!" => [PBTypes::BUG],
			"The dampness strengthened the attack!" => [PBTypes::WATER],
			"Thick mangroves line the area!" => [PBTypes::GRASS],
			"The dampness weakened the flame..." => [PBTypes::FIRE]},
	...
	PBFields::RAINBOWF => {
		...
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::SILVERWIND, PBMoves::MYSTICALFIRE, PBMoves::DRAGONPULSE, 
				...
				PBMoves::CHLOROBLAST, PBMoves::LUMINACRASH, PBMoves::TWINBEAM, PBMoves::LASERPULSE,
				PBMoves::LUSTERBEAM, PBMoves::COSMICRAY],
			0.5 => [PBMoves::DARKPULSE, PBMoves::SHADOWBALL, PBMoves::NIGHTDAZE, PBMoves::NEVERENDINGNIGHTMARE,
				PBMoves::FIERYWRATH, PBMoves::BITTERMALICE, PBMoves::LASTRESPECTS, PBMoves::RAGEFIST,
				PBMoves::DRAINLIFE, PBMoves::DEATHNAIL, PBMoves::BITTERBLADE]},
		:MOVEMESSAGES => {
	...
	PBFields::CORROSIVEF => {
		...
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::SMACKDOWN, PBMoves::MUDSLAP, PBMoves::MUDSHOT, PBMoves::MUDBOMB, 
				...
				PBMoves::APPLEACID, PBMoves::OCEANSWRATH],
		...
		:MOVEMESSAGES => {
			"The corrosion strengthened the attack!" => [PBMoves::SMACKDOWN, PBMoves::MUDSLAP, 
				...
				PBMoves::APPLEACID, PBMoves::OCEANSWRATH, PBMoves::SNAPTRAP]},
		:MOVETYPEMOD => {
		...
		:FIELDCHANGE => {
			PBFields::GRASSYT => [PBMoves::SEEDFLARE,
				PBMoves::PURIFY]},
		:CHANGEMESSAGE => {
			"The polluted field was purified!" => [PBMoves::SEEDFLARE,
				PBMoves::PURIFY]},
	...
	PBFields::CORROSIVEMISTF => {
		...
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::BUBBLEBEAM, PBMoves::ACIDSPRAY, PBMoves::BUBBLE, PBMoves::SMOG, 
				...
				PBMoves::APPLEACID, PBMoves::STRANGESTEAM, PBMoves::HYPERSTINKSHOT, PBMoves::FOGGYSTRIKE,
				PBMoves::NIMBUSFIST, PBMoves::SPARKLYSWIRL, PBMoves::CINDERBREATH],
			2.0 => [PBMoves::MISTYEXPLOSION]},
		...
		:MOVEMESSAGES => {
			"The poison strengthened the attack!" => [PBMoves::BUBBLEBEAM, PBMoves::ACIDSPRAY, 
				...
				PBMoves::APPLEACID, PBMoves::STRANGESTEAM, PBMoves::HYPERSTINKSHOT, PBMoves::FOGGYSTRIKE,
				PBMoves::NIMBUSFIST, PBMoves::SPARKLYSWIRL],
			"The poisonous mist strengthened the attack!" => [PBMoves::CINDERBREATH, PBMoves::MISTYTERRAIN]},
		:MOVETYPEMOD => {
			PBTypes::POISON => [PBMoves::BUBBLE, PBMoves::BUBBLEBEAM, PBMoves::ENERGYBALL, PBMoves::SPARKLINGARIA,
				PBMoves::APPLEACID, PBMoves::STRANGESTEAM, PBMoves::FOGGYSTRIKE, PBMoves::NIMBUSFIST,
				PBMoves::MISTYEXPLOSION, PBMoves::SPARKLYSWIRL]},
		:TYPEDAMAGEBOOST => {1.5 => [PBTypes::FIRE]},
		:TYPEMESSAGES => {"The toxic mist caught flame!" => [PBTypes::FIRE]},
		:FIELDCHANGE => {
			0 => PBFields::BLOWMOVES + PBFields::IGNITEMOVES + [PBMoves::SELFDESTRUCT, PBMoves::EXPLOSION],
			PBFields::CORROSIVEF => [PBMoves::GRAVITY],
			PBFields::MISTYT => [PBMoves::SEEDFLARE, PBMoves::PURIFY]},
		...
		:CHANGEMESSAGE => {
			...
			"The polluted mist was purified!" => [PBMoves::SEEDFLARE, PBMoves::PURIFY],
	...
	PBFields::DESERTF => {
		...
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::NEEDLEARM, PBMoves::PINMISSILE, PBMoves::DIG, PBMoves::SANDTOMB, 
				...
				PBMoves::SCORCHINGSANDS, PBMoves::SANDSEARSTORM, PBMoves::DRYNEEDLES, PBMoves::CACTUSSMASH],
			3.0 => [PBMoves::SCALD, PBMoves::STEAMERUPTION, PBMoves::HYDROSTEAM]},
		:MOVEMESSAGES => {
			"The desert strengthened the attack!" => [PBMoves::NEEDLEARM, PBMoves::PINMISSILE, 
				...
				PBMoves::SCORCHINGSANDS, PBMoves::SANDSEARSTORM, PBMoves::DRYNEEDLES, PBMoves::CACTUSSMASH,
				PBMoves::SCALD, PBMoves::STEAMERUPTION, PBMoves::HYDROSTEAM]},
	...
	PBFields::ICYF => {
		...
		:MOVEDAMAGEBOOST => { 
			0.5 => [PBMoves::SCALD, PBMoves::STEAMERUPTION,
				PBMoves::SCORCHINGSANDS, PBMoves::INFERNALWATERBLAST, PBMoves::HYDROSTEAM],
			1.2 => [PBMoves::SNIPESHOT],
			1.5 => [PBMoves::BITTERMALICE, PBMoves::FREEZINGGLARE, PBMoves::BLEAKWINDSTORM, PBMoves::BRAINFREEZE],
			2.0 => [PBMoves::CHILLINGWATER]},
		:MOVEACCURACYBOOST => {100 => [PBMoves::MOUNTAINGALE]},
		:MOVEMESSAGES => {
			"The cold softened the attack..." => [PBMoves::SCALD, PBMoves::STEAMERUPTION,
				PBMoves::SCORCHINGSANDS, PBMoves::INFERNALWATERBLAST, PBMoves::HYDROSTEAM],
	  		"The cold air crystallized the missile!" => [PBMoves::SNIPESHOT],
			"The cold strengthened the attack!" => [PBMoves::BITTERMALICE, PBMoves::FREEZINGGLARE, PBMoves::BLEAKWINDSTORM, PBMoves::BRAINFREEZE,
				PBMoves::CHILLINGWATER]},
		:MOVETYPEMOD => {PBTypes::ICE => [PBMoves::SNIPESHOT]},
		:TYPEDAMAGEBOOST => {
			1.5 => [PBTypes::ICE],
			0.5 => [PBTypes::FIRE]},
		:TYPEMESSAGES => {
	...
	PBFields::FORESTF => {
		...
		:MOVEDAMAGEBOOST => {
			...
			1.5 => PBFields::SLASHMOVES + [PBMoves::ATTACKORDER, PBMoves::ELECTROWEB, PBMoves::SKITTERSMACK, PBMoves::DRUMBEATING, PBMoves::POUNCE,
				PBMoves::BREAKINGSWIPE, PBMoves::VENOMSWIPE, PBMoves::FORESTFRENZY],
			1.334 => [PBMoves::GRAVAPPLE]},
		:MOVEMESSAGES => {
			"The forest softened the attack..." => [PBMoves::SURF, PBMoves::MUDDYWATER],
			"They're coming out of the woodwork!" => [PBMoves::ATTACKORDER, PBMoves::SKITTERSMACK, PBMoves::POUNCE],
			"Gossamer and arbor strengthened the attack!" => [PBMoves::ELECTROWEB],
			"Jungle Drum!" => [PBMoves::DRUMBEATING],
			"The target was cut down to size!" => PBFields::SLASHMOVES + [PBMoves::BREAKINGSWIPE, PBMoves::VENOMSWIPE],
			"The forest started to run wild!" => [PBMoves::FORESTFRENZY],
			"The apple did not fall far from the tree." => [PBMoves::GRAVAPPLE]},
	...
	PBFields::SUPERHEATEDF => {
		...
		:MOVEDAMAGEBOOST => {
			0.625 => [PBMoves::SURF, PBMoves::MUDDYWATER, PBMoves::WATERPLEDGE, 
				...
				PBMoves::CHILLINGWATER, PBMoves::CORALBREAK],
			1.667 => [PBMoves::SCALD, PBMoves::STEAMERUPTION,
				PBMoves::INFERNALWATERBLAST, PBMoves::HYDROSTEAM],
			1.1 => [PBMoves::INFERNALPARADE]},
		:MOVEMESSAGES => {
			...
			"The extreme heat softened the attack..." => [PBMoves::CHILLINGWATER],
			"The field super-heated the attack!" => [PBMoves::SCALD, PBMoves::STEAMERUPTION,
				PBMoves::INFERNALWATERBLAST, PBMoves::HYDROSTEAM],
			"The attack was super-heated!" => [PBMoves::INFERNALPARADE]},
		:TYPEDAMAGEBOOST => {
			0.5 => [PBTypes::ICE],
			0.9 => [PBTypes::WATER],
			1.1 => [PBTypes::FIRE]},
		...
		:FIELDCHANGE => {
			PBFields::BURNINGF => PBFields::IGNITEMOVES + [PBMoves::SELFDESTRUCT, PBMoves::EXPLOSION,
				PBMoves::MISTYEXPLOSION, PBMoves::FISSIONBURST],
	...
	PBFields::FACTORYF => {
		...
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::STEAMROLLER, PBMoves::TECHNOBLAST, PBMoves::DOUBLEIRONBASH,
				PBMoves::AURAWHEELMINUS, PBMoves::THUNDEROUSKICK],
			2.0 => [PBMoves::FLASHCANNON, PBMoves::GYROBALL, PBMoves::MAGNETBOMB, PBMoves::GEARGRIND,
				PBMoves::DOUBLEIRONBASH, PBMoves::HARDPRESS]},
		:MOVEMESSAGES => {
			"ATTACK SEQUENCE UPDATE." => [PBMoves::STEAMROLLER, PBMoves::TECHNOBLAST],
			"ATTACK SEQUENCE INITIATE." => [PBMoves::FLASHCANNON, PBMoves::GYROBALL, PBMoves::DOUBLEIRONBASH,
				PBMoves::MAGNETBOMB, PBMoves::GEARGRIND,
				PBMoves::DOUBLEIRONBASH, PBMoves::HARDPRESS],
			"The attack took energy from the field!" => [PBMoves::AURAWHEELMINUS, PBMoves::THUNDEROUSKICK]},
		:TYPEDAMAGEBOOST => {1.5 => [PBTypes::ELECTRIC]},
	...
	PBFields::SHORTCIRCUITF => {
		...
		:MIMICRY => PBTypes::ELECTRIC,
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::DAZZLINGGLEAM, PBMoves::SURF, PBMoves::MUDDYWATER, PBMoves::MAGNETBOMB, PBMoves::INFERNALPARADE,
				PBMoves::GYROBALL, PBMoves::FLASHCANNON, PBMoves::GEARGRIND, PBMoves::HYDROVORTEX,
				PBMoves::WILDBOLTSTORM, PBMoves::IONICWHIPLASH, PBMoves::AMBUSH, PBMoves::LUMINACRASH,
				PBMoves::GEMSTONEGLIMMER, PBMoves::HARDPRESS, PBMoves::LIGHTOFRUIN, PBMoves::SPLISHYSPLASH],
			1.3 => [PBMoves::DARKPULSE, PBMoves::NIGHTDAZE, PBMoves::NIGHTSLASH, 
				PBMoves::SHADOWBALL, PBMoves::SHADOWPUNCH, PBMoves::SHADOWCLAW,
				PBMoves::SHADOWSNEAK, PBMoves::SHADOWFORCE, PBMoves::SHADOWBONE,
				PBMoves::FIERYWRATH],
			0.5 => [PBMoves::LIGHTTHATBURNSTHESKY],
			2.0 => [PBMoves::WEAKENINGJUMPSCARE]},
		:MOVEACCURACYBOOST => {80 => [PBMoves::ZAPCANNON]},
		:MOVEMESSAGES => {
			"Blinding!" => [PBMoves::DAZZLINGGLEAM,
				PBMoves::LUMINACRASH, PBMoves::GEMSTONEGLIMMER, PBMoves::LIGHTOFRUIN], 
			"The attack picked up electricity!" => [PBMoves::SURF, PBMoves::MUDDYWATER, PBMoves::STEELBEAM, PBMoves::DOUBLEIRONBASH,
				PBMoves::MAGNETBOMB, PBMoves::GYROBALL, PBMoves::FLASHCANNON, PBMoves::GEARGRIND, PBMoves::HYDROVORTEX,
				PBMoves::WILDBOLTSTORM, PBMoves::IONICWHIPLASH, PBMoves::HARDPRESS, PBMoves::SPLISHYSPLASH],
			"The darkness strengthened the attack!" => [PBMoves::DARKPULSE, PBMoves::NIGHTDAZE, 
				...
				PBMoves::SHADOWSNEAK, PBMoves::SHADOWFORCE, PBMoves::SHADOWBONE, PBMoves::INFERNALPARADE,
				PBMoves::FIERYWRATH, PBMoves::AMBUSH, PBMoves::WEAKENINGJUMPSCARE],
			"{1} couldn't consume much light..." => [PBMoves::LIGHTTHATBURNSTHESKY]},
		:MOVETYPEMOD => {
			PBTypes::ELECTRIC => [PBMoves::SURF, PBMoves::MUDDYWATER, PBMoves::MAGNETBOMB, PBMoves::DOUBLEIRONBASH,
				PBMoves::GYROBALL, PBMoves::FLASHCANNON, PBMoves::GEARGRIND, PBMoves::STEELBEAM,
				PBMoves::IONICWHIPLASH, PBMoves::HARDPRESS, PBMoves::SPLISHYSPLASH]},
		:FIELDCHANGE => {
			PBFields::FACTORYF => [PBMoves::PARABOLICCHARGE, PBMoves::WILDCHARGE, PBMoves::RISINGVOLTAGE,
				PBMoves::CHARGEBEAM, PBMoves::IONDELUGE, PBMoves::GIGAVOLTHAVOC]},
		:CHANGEMESSAGE => {
			"SYSTEM ONLINE." => [PBMoves::PARABOLICCHARGE, PBMoves::WILDCHARGE, 
				PBMoves::CHARGEBEAM, PBMoves::IONDELUGE, PBMoves::GIGAVOLTHAVOC]},
	...
	PBFields::WASTELAND => {
		...
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::VINEWHIP, PBMoves::POWERWHIP, PBMoves::MUDSLAP,
				...
				PBMoves::TARTANTRUM, PBMoves::HYPERSTINKSHOT],
			0.25 => [PBMoves::EARTHQUAKE, PBMoves::MAGNITUDE, PBMoves::BULLDOZE,
				PBMoves::SUBDUCTION],
			2.0 => [PBMoves::SPITUP],
		...
		:MOVEMESSAGES => {
			...
			"*sputter*" => [PBMoves::SPINOUT, PBMoves::BLAZINGTORQUE, PBMoves::WICKEDTORQUE, PBMoves::NOXIOUSTORQUE,
				PBMoves::COMBATTORQUE, PBMoves::MAGICALTORQUE],
			"This is actually so gross..." => [PBMoves::YUCKYTONGUE]},
		:TYPEDAMAGEBOOST => {0.5 => [PBTypes::NUCLEAR]},
		:MOVETYPEMOD => {
			PBTypes::POISON => [PBMoves::MUDBOMB, PBMoves::MUDSLAP, PBMoves::MUDSHOT]},
		:FIELDCHANGE => {
			PBFields::FLOWERGARDENF => [PBMoves::PURIFY, PBMoves::SEEDFLARE]},
		:CHANGEMESSAGE => {
			"The polluted field was purified!" => [PBMoves::PURIFY, PBMoves::SEEDFLARE]},
	...
	PBFields::ASHENB => {
		...
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::HIDDENPOWER, PBMoves::STRENGTH, PBMoves::LANDSWRATH, 
				...
				PBMoves::HIDDENPOWERROC,PBMoves::HIDDENPOWERICE,PBMoves::HIDDENPOWERBUG,PBMoves::HIDDENPOWERDRA,PBMoves::HIDDENPOWERGHO,
				PBMoves::HIDDENPOWERDAR,PBMoves::HIDDENPOWERSTE,PBMoves::HIDDENPOWERFAI,
				PBMoves::BRINE, PBMoves::CRABHAMMER, PBMoves::SANDSEARSTORM, PBMoves::SCORCHINGSANDS,
				PBMoves::RAZORSHELL, PBMoves::SHELLSIDEARM, PBMoves::SMELLINGSALTS, PBMoves::WAVECRASH,
				PBMoves::CORALBREAK, PBMoves::FOCUSEDRAM, PBMoves::FLASHFLOOD, PBMoves::CINDERBREATH,
				PBMoves::BRAINSTORM, PBMoves::SHELLTRAP],
			2.0 => [PBMoves::MUDSLAP, PBMoves::MUDSHOT, PBMoves::MUDBOMB , PBMoves::SANDTOMB],
			1.3 => [PBMoves::STOREDPOWER, PBMoves::ZENHEADBUTT, PBMoves::FOCUSBLAST, PBMoves::AURASPHERE,
				PBMoves::FOCUSPUNCH],
			1.2 => [PBMoves::PSYCHIC]},
		...
		:MOVEMESSAGES => {
			"...And with pure focus!" => [PBMoves::HIDDENPOWER, PBMoves::STRENGTH, PBMoves::CLANGOROUSSOULBLAZE,
				...
				PBMoves::HIDDENPOWERROC,PBMoves::HIDDENPOWERICE,PBMoves::HIDDENPOWERBUG,PBMoves::HIDDENPOWERDRA,PBMoves::HIDDENPOWERGHO,
				PBMoves::HIDDENPOWERDAR,PBMoves::HIDDENPOWERSTE,PBMoves::HIDDENPOWERFAI,
				PBMoves::FOCUSEDRAM, PBMoves::BRAINSTORM], 
			"The sand strengthened the atttack!" => [PBMoves::LANDSWRATH, PBMoves::THOUSANDWAVES,
				PBMoves::SCORCHINGSANDS, PBMoves::SANDSEARSTORM, PBMoves::SMELLINGSALTS], 
			"Surf's up!" => [PBMoves::SURF, PBMoves::MUDDYWATER,
				PBMoves::WAVECRASH, PBMoves::CORALBREAK, PBMoves::FLASHFLOOD],
			"Ash mixed into the attack!" => [PBMoves::MUDSLAP, PBMoves::MUDSHOT, PBMoves::MUDBOMB , PBMoves::SANDTOMB,
				PBMoves::CINDERBREATH],
			"...And with full focus...!" => [PBMoves::STOREDPOWER, PBMoves::ZENHEADBUTT, PBMoves::FOCUSBLAST, PBMoves::AURASPHERE,
				PBMoves::FOCUSPUNCH],
			"...And with focus...!" => [PBMoves::PSYCHIC],
			"Time for crab!" => [PBMoves::CRABHAMMER],
			"The salty sea strengthened the attack!" => [PBMoves::BRINE],
			"A shining shell on the beach!" => [PBMoves::RAZORSHELL, PBMoves::SHELLSIDEARM, PBMoves::SHELLTRAP]},
		:MOVETYPEMOD => {PBTypes::PSYCHIC => [PBMoves::STRENGTH]},
		:STATUSMOVEBOOST => [PBMoves::CALMMIND, PBMoves::KINESIS, PBMoves::MEDITATE, PBMoves::SANDATTACK, PBMoves::COACHING,
	...
	PBFields::WATERS => {
		...
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::SURF, PBMoves::MUDDYWATER, PBMoves::WHIRLPOOL, PBMoves::DIVE, PBMoves::HYDROVORTEX,
				PBMoves::AURAWHEELMINUS, PBMoves::OCEANSWRATH],
			2.0 => [PBMoves::WAVECRASH],
			1.2 => [PBMoves::SLUDGEWAVE],
			0.5 => [PBMoves::INFERNALPARADE]},
		:MOVEMESSAGES => {
			"The attack rode the current!" => [PBMoves::SURF, PBMoves::MUDDYWATER, PBMoves::WHIRLPOOL, PBMoves::DIVE, PBMoves::HYDROVORTEX, PBMoves::WAVECRASH],
			"The water deluged the attack..." => [PBMoves::INFERNALPARADE]},
		:TYPEDAMAGEBOOST => {
		...
		:FIELDCHANGE => {
			PBFields::UNDERWATER => [PBMoves::GRAVITY,PBMoves::DIVE,
				PBMoves::GRAVAPPLE, PBMoves::ANCHORSHOT],
	...
	PBFields::UNDERWATER => {
		...
		:MOVEDAMAGEBOOST => {
			...
			2.0 => [PBMoves::ANCHORSHOT,
				PBMoves::DRAGONDARTS, PBMoves::AURAWHEELMINUS]},
		:MOVETYPEMOD => {
			PBTypes::WATER => [PBMoves::GRAVAPPLE, PBMoves::DRAGONDARTS]},
		:MOVEMESSAGES => {
			"Jet-streamed!" => [PBMoves::WATERPULSE, PBMoves::WAVECRASH],
		...
		:FIELDCHANGE => {PBFields::WATERS => [PBMoves::DIVE, PBMoves::SKYDROP, PBMoves::FLY, PBMoves::BOUNCE,
			PBMoves::SHOREUP]},
		:CHANGEMESSAGE => {"The battle resurfaced!" => [PBMoves::DIVE, PBMoves::SKYDROP, PBMoves::FLY, PBMoves::BOUNCE,
			PBMoves::SHOREUP]},
	...
	PBFields::CAVE => {
		...
		:FIELDCHANGE => {
			PBFields::CRYSTALC => [PBMoves::POWERGEM, PBMoves::DIAMONDSTORM,
				PBMoves::GEMSTONEGLIMMER, PBMoves::DECRYSTALLIZATION, PBMoves::TERASTARSTORM],
			PBFields::CAVE => PBFields::QUAKEMOVES + [PBMoves::CONTINENTALCRUSH],
			PBFields::ICYF => [PBMoves::BLIZZARD, PBMoves::SUBZEROSLAMMER]},
		:DONTCHANGEBACKUP => [PBMoves::POWERGEM, PBMoves::DIAMONDSTORM],
		:CHANGEMESSAGE => {
			"The cave was littered with crystals!" => [PBMoves::POWERGEM, PBMoves::DIAMONDSTORM,
				PBMoves::GEMSTONEGLIMMER, PBMoves::DECRYSTALLIZATION, PBMoves::TERASTARSTORM],
			"The cavern froze over!" => [PBMoves::BLIZZARD, PBMoves::SUBZEROSLAMMER]},
		:CHANGECONDITION => {},
		:STATUSMOVEBOOST => [PBMoves::STEALTHROCK, PBMoves::DECRYSTALLIZATION],
		:CHANGEEFFECTS => {},
		:SEED => PBItems::TELLURICSEED,
		:SEEDEFFECT => 0,
		:SEEDEFFECTVAL => 0,
	...
	PBFields::GLITCHF => {
		...
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::HM04, PBMoves::HM05, PBMoves::TM53, PBMoves::TM24]},
		:MOVEACCURACYBOOST => {90 => [PBMoves::BLIZZARD]},
		:MOVEMESSAGES => {
			"tH3 AtTaCk G1!tCh3d 0uT--!" => [PBMoves::HM04, PBMoves::HM05, PBMoves::TM53, PBMoves::TM24]},
	...
	PBFields::CRYSTALC => {
		...
		:MOVEDAMAGEBOOST => {
			1.3 => [PBMoves::AURORABEAM, PBMoves::SIGNALBEAM, PBMoves::FLASHCANNON, 
				...
				PBMoves::DYNAMAXCANNON, PBMoves::ETERNABEAM, PBMoves::LUMINACRASH],
			1.5 => [PBMoves::POWERGEM, PBMoves::DIAMONDSTORM, PBMoves::ANCIENTPOWER, 
				...
				PBMoves::LASERPULSE, PBMoves::GEMSTONEGLIMMER, PBMoves::TERASTARSTORM, PBMoves::LIGHTOFRUIN]},
		:MOVEMESSAGES => {
			"The crystals' light strengthened the attack!" => [PBMoves::AURORABEAM, 
				PBMoves::SIGNALBEAM, PBMoves::FLASHCANNON, PBMoves::LUSTERPURGE, 
				PBMoves::DAZZLINGGLEAM, PBMoves::MIRRORSHOT, PBMoves::TECHNOBLAST, 
				...
				PBMoves::DYNAMAXCANNON, PBMoves::ETERNABEAM, PBMoves::LUMINACRASH, PBMoves::GEMSTONEGLIMMER,
				PBMoves::LASERPULSE, PBMoves::LIGHTOFRUIN],
			"The crystals strengthened the attack!" => [PBMoves::POWERGEM, PBMoves::DIAMONDSTORM, 
				...
				PBMoves::GEMSTONEGLIMMER, PBMoves::TERASTARSTORM]},
		...
		:DONTCHANGEBACKUP => PBFields::QUAKEMOVES + [PBMoves::DARKPULSE, PBMoves::DARKVOID, PBMoves::NIGHTDAZE,
			PBMoves::TIDYUP, PBMoves::FIERYWRATH],
		:CHANGEMESSAGE => {
			"The crystals were broken up!" => PBFields::QUAKEMOVES,
			"The crystals' light was warped by the darkness!" => [PBMoves::DARKPULSE, PBMoves::DARKVOID, PBMoves::NIGHTDAZE,
				PBMoves::FIERYWRATH],
			"The crystals' light was consumed!" => [PBMoves::LIGHTTHATBURNSTHESKY],
			"The crystals were swept up!" => [PBMoves::TIDYUP]},
		:STATUSMOVEBOOST => [PBMoves::ROCKPOLISH, PBMoves::STEALTHROCK, PBMoves::DECRYSTALLIZATION],
		:CHANGEEFFECTS => {},
		:SEED => PBItems::MAGICALSEED,
		:SEEDEFFECT => PBEffects::MagicCoat,
		:SEEDEFFECTVAL => true,
	...
	PBFields::MURKWATERS => {
		...
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::MUDBOMB, PBMoves::MUDSLAP, PBMoves::MUDSHOT, PBMoves::SMACKDOWN, 
				PBMoves::ACID, PBMoves::ACIDSPRAY, PBMoves::BRINE, PBMoves::THOUSANDWAVES, PBMoves::WAVECRASH,
				PBMoves::APPLEACID],
			1.3 => [PBMoves::AURAWHEELMINUS]},
		:MOVEMESSAGES => {
			...
			"A toxic wave crashes down!" => [PBMoves::WAVECRASH],
			"The toxic water conducted the attack!" => [PBMoves::AURAWHEELMINUS]},
		:MOVETYPEMOD => {
			PBTypes::POISON => [PBMoves::MUDBOMB, PBMoves::MUDSLAP, PBMoves::MUDSHOT, PBMoves::SMACKDOWN, PBMoves::THOUSANDWAVES,
				PBMoves::APPLEACID],
		...
		:FIELDCHANGE => {
			PBFields::WATERS => [PBMoves::WHIRLPOOL,
				PBMoves::PURIFY, PBMoves::SEEDFLARE, PBMoves::OCEANSWRATH],
			PBFields::ICYF => [PBMoves::BLIZZARD, PBMoves::GLACIATE,PBMoves::SUBZEROSLAMMER]},
		...
		:CHANGEMESSAGE => {
			...
			"The polluted water was purified!" => [PBMoves::PURIFY, PBMoves::SEEDFLARE]},
		:STATUSMOVEBOOST => [PBMoves::ACIDARMOR],
		:CHANGEEFFECTS => {},
		:SEED => PBItems::ELEMENTALSEED,
		:SEEDEFFECT => PBEffects::AquaRing,
	...
	PBFields::MOUNTAIN => {
		...
		:MIMICRY => PBTypes::ROCK,
		:MOVETYPEMOD => {PBTypes::ROCK => [PBMoves::MOUNTAINGALE]},
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::VITALTHROW, PBMoves::CIRCLETHROW, PBMoves::STORMTHROW, 
				...
				PBMoves::AVALANCHE, PBMoves::HYPERVOICE, PBMoves::MOUNTAINGALE,
				PBMoves::WILDBOLTSTORM, PBMoves::BLEAKWINDSTORM, PBMoves::SANDSEARSTORM, PBMoves::SPRINGTIDESTORM,
				PBMoves::ESPERWING, PBMoves::DRAGONDESCENT]},
		:MOVEMESSAGES => {
			"{1} was thrown partway down the mountain!" => [PBMoves::VITALTHROW, 
				PBMoves::CIRCLETHROW, PBMoves::STORMTHROW],
			"The whole mountain is moving!" => [PBMoves::MOUNTAINGALE],
			...
			"The open air strengthened the attack!" => [PBMoves::DRAGONDESCENT]},
		...
		:FIELDCHANGE => {
			PBFields::SNOWYM => [PBMoves::BLIZZARD, PBMoves::GLACIATE,PBMoves::SUBZEROSLAMMER,
				PBMoves::MOUNTAINGALE]},
		:DONTCHANGEBACKUP => [PBMoves::BLIZZARD, PBMoves::GLACIATE,PBMoves::SUBZEROSLAMMER,
			PBMoves::MOUNTAINGALE],
	...
	PBFields::SNOWYM => {
		...
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::VITALTHROW, PBMoves::CIRCLETHROW, PBMoves::STORMTHROW, 
				...
				PBMoves::GLACIATE,
				PBMoves::BITTERMALICE, PBMoves::FREEZINGGLARE, PBMoves::WILDBOLTSTORM, PBMoves::BLEAKWINDSTORM,
				PBMoves::SPRINGTIDESTORM, PBMoves::ESPERWING, PBMoves::ANCIENTICESHARD, PBMoves::DRAGONDESCENT,
				PBMoves::BRAINFREEZE, PBMoves::THUNDERCLAP],
			0.5 => [PBMoves::SCALD, PBMoves::STEAMERUPTION,
				PBMoves::SCORCHINGSANDS, PBMoves::FIERYWRATH, PBMoves::INFERNALPARADE, PBMoves::HYDROSTEAM],
			2.0 => [PBMoves::ICYWIND,
				PBMoves::CHILLINGWATER]},
		:MOVEMESSAGES => {
			"{1} was thrown partway down the mountain!" => [PBMoves::VITALTHROW, 
			...
			"The wind strengthened the attack!" => [PBMoves::OMINOUSWIND, PBMoves::SILVERWIND, 
				...
				PBMoves::WILDBOLTSTORM, PBMoves::BLEAKWINDSTORM, PBMoves::SPRINGTIDESTORM, PBMoves::ESPERWING], 
			"The snow strengthened the attack!" => [PBMoves::AVALANCHE, PBMoves::POWDERSNOW,
				PBMoves::ANCIENTICESHARD],
			"The cold softened the attack..." => [PBMoves::SCALD, PBMoves::STEAMERUPTION,
				PBMoves::SCORCHINGSANDS, PBMoves::FIERYWRATH, PBMoves::INFERNALPARADE, PBMoves::HYDROSTEAM],
			"The frigid wind strengthened the attack!" => [PBMoves::ICYWIND,
				PBMoves::CHILLINGWATER, PBMoves::BITTERMALICE, PBMoves::FREEZINGGLARE],
			"Yodelayheehoo~" => [PBMoves::HYPERVOICE],
			"The open air strengthened the attack!" => [PBMoves::DRAGONDESCENT],
			"And with a sharp clap!" => [PBMoves::THUNDERCLAP]},
		:TYPETYPEMOD => {PBTypes::ICE => [PBTypes::ROCK]},
		:TYPEDAMAGEBOOST => {
		...
		:TYPEMESSAGES => {
			...
			"The open air strengthened the attack!" => [PBTypes::FLYING],
			"The cold softened the attack!" => [PBTypes::FIRE]},
		:FIELDCHANGE => {PBFields::MOUNTAIN => PBFields::IGNITEMOVES + [PBMoves::RAGINGFURY, PBMoves::TIDYUP]},
		:CHANGEMESSAGE => {
			"The snow melted away!" => PBFields::IGNITEMOVES + [PBMoves::RAGINGFURY],
			"The snow was swept away!" => [PBMoves::TIDYUP]},
	...
	PBFields::HOLYF => {
		...
		:MOVEDAMAGEBOOST => {
			1.3 => [PBMoves::PSYSTRIKE, PBMoves::AEROBLAST, 
				...
				PBMoves::MENACINGMOONRAZEMAELSTROM,
			        PBMoves::COSMICRAY, PBMoves::DEJAVU, PBMoves::ASTRALSHOT,
			        PBMoves::COMETSHOWER, PBMoves::BIGBANG2,
				PBMoves::DYNAMAXCANNON, PBMoves::BEHEMOTHBLADE, PBMoves::BEHEMOTHBASH, PBMoves::ETERNABEAM,
				PBMoves::DRAGONDESCENT, PBMoves::HYDROSTEAM, PBMoves::PSYBLADE, PBMoves::THUNDERCLAP,
				PBMoves::TACHYONCUTTER, PBMoves::MIGHTYCLEAVE, PBMoves::LIGHTOFRUIN, PBMoves::TERASTARSTORM,
				PBMoves::MYSTICALPOWER],
			...
			0.5 => [PBMoves::INFERNALBLADE, PBMoves::INFERNALFIREBLAST, PBMoves::INFERNALWATERBLAST, PBMoves::BITTERBLADE]},
		:MOVEMESSAGES => {
			...
			"The attack was cleansed..." => [PBMoves::INFERNALBLADE, PBMoves::INFERNALFIREBLAST, PBMoves::INFERNALWATERBLAST, PBMoves::BITTERBLADE]},
		:TYPEDAMAGEBOOST => {
	...
	PBFields::MIRRORA => {
		...
		:MIMICRY => PBTypes::STEEL,
		:MOVEDAMAGEBOOST => {
			1.5 => PBFields::BLINDINGMOVES + [PBMoves::FLOWERTRICK],
		...
		:MOVEMESSAGES => {
			...
			"Now you see it, now you don't!" => [PBMoves::FLOWERTRICK]},
		:FIELDCHANGE => {
			0 => PBFields::QUAKEMOVES + [PBMoves::BOOMBURST, PBMoves::HYPERVOICE, PBMoves::SELFDESTRUCT, PBMoves::EXPLOSION,
				PBMoves::OVERDRIVE, PBMoves::MISTYEXPLOSION, PBMoves::RAGINGBULL, PBMoves::RUINATION,
				PBMoves::COLLISIONCOURSE, PBMoves::FISSIONBURST]},
		:STATUSMOVEBOOST => [PBMoves::LIGHTSCREEN, PBMoves::AURORAVEIL, PBMoves::SOLARARRAY, PBMoves::REFLECT, PBMoves::MIRRORMOVE,
	...
	PBFields::FAIRYTALEF => {
		...
		:MIMICRY => PBTypes::FAIRY,
		:MOVEDAMAGEBOOST => {
			1.5 => PBFields::SLASHMOVES + [PBMoves::SMARTSTRIKE, PBMoves::MAGICALLEAF, 
				...
				PBMoves::BEHEMOTHBASH, PBMoves::ANCIENTICESHARD],
			2.0 => [PBMoves::DRAININGKISS,
				PBMoves::MISTBALL]},
		:MOVEMESSAGES => {
			"The blade cuts true!" => PBFields::SLASHMOVES + [PBMoves::SMARTSTRIKE],
      			"Royal execution!" => [PBMoves::KOWTOWCLEAVE],
			"The magical energy strengthened the attack!" => [PBMoves::MAGICALLEAF, 
				...
				PBMoves::MENACINGMOONRAZEMAELSTROM,
				PBMoves::BEHEMOTHBASH, PBMoves::ANCIENTICESHARD, PBMoves::MISTBALL],
			"True love never hurt so badly!" => [PBMoves::DRAININGKISS]},
		:MOVETYPEMOD => {PBTypes::FIRE => [PBMoves::INFERNALBLADE]},
	...
	PBFields::DRAGONSD => {
		...
		:MIMICRY => PBTypes::DRAGON,
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::MEGAKICK, PBMoves::MAGMASTORM, PBMoves::LAVAPLUME, PBMoves::MAKEITRAIN,
				PBMoves::POWERGEM, PBMoves::DIAMONDSTORM, PBMoves::EARTHPOWER, PBMoves::STOMPINGTANTRUM,
				PBMoves::SHELLTRAP, PBMoves::ROCKCLIMB, PBMoves::STRENGTH, PBMoves::TEMPERFLARE,
				PBMoves::DRAGONENERGY, PBMoves::FIERYWRATH, PBMoves::INFERNALPARADE, PBMoves::GOLDENFIST,
				PBMoves::GEMSTONEGLIMMER, PBMoves::TERASTARSTORM],
			2.0 => [PBMoves::SMACKDOWN, PBMoves::THOUSANDARROWS, PBMoves::DRAGONASCENT, 
				...
				PBMoves::MISTBALL, PBMoves::LUSTERPURGE],
			1.334 => [PBMoves::DRAGONDESCENT]},
		:MOVEACCURACYBOOST => {
			100 => [PBMoves::DRAGONRUSH]},
		:MOVEMESSAGES => {
			"Trial of the Dragon!!!" => [PBMoves::MEGAKICK], 
			"The lava strengthened the attack!" => [PBMoves::MAGMASTORM, PBMoves::LAVAPLUME,
				PBMoves::EARTHPOWER, PBMoves::SHELLTRAP, PBMoves::INFERNALPARADE],
			...
			"The draconic energy boosted the attack!" => [PBMoves::DRAGONASCENT,
				PBMoves::LUSTERPURGE, PBMoves::MISTBALL, PBMoves::DRAGONDESCENT, PBMoves::DRAGONENERGY], 
			"money money money money money mothafucka" => [PBMoves::PAYDAY, PBMoves::MAKEITRAIN,
				PBMoves::GOLDENFIST],
			"Wrath of the Dragon!!!" => [PBMoves::STOMPINGTANTRUM, PBMoves::TEMPERFLARE, PBMoves::FIERYWRATH],
			"Sparkling treasure!" => [PBMoves::POWERGEM, PBMoves::DIAMONDSTORM, PBMoves::GEMSTONEGLIMMER, PBMoves::TERASTARSTORM],
			"Unrivaled Power!" => [PBMoves::ROCKCLIMB, PBMoves::STRENGTH]},
		:MOVETYPEMOD => {
			PBTypes::FIRE => [PBMoves::SMACKDOWN, PBMoves::THOUSANDARROWS, PBMoves::TECTONICRAGE, PBMoves::CONTINENTALCRUSH,
				PBMoves::ROCKCLIMB, PBMoves::STRENGTH, PBMoves::EARTHQUAKE, PBMoves::SUBDUCTION]},
		:TYPEDAMAGEBOOST => {
		...
		:TYPEMESSAGES => {
			...
			"The lava's heat started melting the rock!" => [PBTypes::ROCK]},
		:FIELDCHANGE => {
			PBFields::CAVE => [PBMoves::GLACIATE, PBMoves::SUBZEROSLAMMER, PBMoves::OCEANICOPERETTA, PBMoves::HYDROVORTEX],
			PBFields::FAIRYTALEF => [PBMoves::MISTBALL]},
		:CHANGEMESSAGE => {
			...
			"The mist-ical energy altered the surroundings!" => [PBMoves::MISTBALL]},
	...
	PBFields::FLOWERGARDENF => { #fuck
		...
		:MOVEDAMAGEBOOST => { #fuck
			1.5 => [PBMoves::MIDNIGHTPHOTOSYNTHESIS]},
		:MOVEMESSAGES => { #fuck
			"Night or day, the attack thrives!" => [PBMoves::MIDNIGHTPHOTOSYNTHESIS]},
		:FIELDCHANGE => {PBFields::BURNINGF => PBFields::IGNITEMOVES},
	...
	PBFields::STARLIGHTA => {
		...
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::AURORABEAM, PBMoves::SIGNALBEAM, PBMoves::FLASHCANNON, 
				...
				PBMoves::MOONBLAST, PBMoves::METEORBEAM,
				PBMoves::ASTRALBARRAGE, PBMoves::LUMINACRASH, PBMoves::GEMSTONEGLIMMER, PBMoves::TERASTARSTORM,
				PBMoves::MIDNIGHTPHOTOSYNTHESIS, PBMoves::BLOODMOON],
			2.0 => [PBMoves::DRACOMETEOR, PBMoves::METEORMASH, PBMoves::COMETPUNCH, 
				...
				PBMoves::METEORASSAULT, PBMoves::BIGBANG],
			4.0 => [PBMoves::DOOMDUMMY],
			1.334 => [PBMoves::BIGBANG2]},
		:MOVEMESSAGES => {
			"Starlight surged through the attack!" => [PBMoves::AURORABEAM, PBMoves::SIGNALBEAM, 
				...
				PBMoves::TECHNOBLAST, PBMoves::SOLARBEAM, PBMoves::PHOTONGEYSER,
				PBMoves::LUMINACRASH, PBMoves::GEMSTONEGLIMMER, PBMoves::TERASTARSTORM, PBMoves::MIDNIGHTPHOTOSYNTHESIS],
			...
			"The astral energy boosted the attack!" => [PBMoves::DRACOMETEOR, PBMoves::METEORMASH, 
				...
				PBMoves::HYPERSPACEFURY, PBMoves::MOONGEISTBEAM, PBMoves::SUNSTEELSTRIKE, PBMoves::METEORBEAM,
				PBMoves::BLACKHOLEECLIPSE, PBMoves::SEARINGSUNRAZESMASH, PBMoves::MENACINGMOONRAZEMAELSTROM,
				PBMoves::METEORASSAULT, PBMoves::ASTRALBARRAGE],
			"The astral vortex accelerated the attack!" => [PBMoves::HYPERSPACEHOLE],
			"A star came crashing down!" => [PBMoves::DOOMDUMMY],
			"The blood red moon shone across the sky!" => [PBMoves::BLOODMOON],
			"The universe has started once again!" => [PBMoves::BIGBANG, PBMoves::BIGBANG2]},
		:MOVETYPEMOD => {
			PBTypes::FIRE => [PBMoves::DOOMDUMMY],
			PBTypes::DARK => [PBMoves::METEORBEAM],
			PBTypes::FAIRY => [PBMoves::SOLARBEAM, PBMoves::SOLARBLADE, PBMoves::CHLOROBLAST, PBMoves::BLOODMOON]},
		:TYPETYPEMOD => {PBTypes::FAIRY => [PBTypes::DARK]},
		:TYPEDAMAGEBOOST => {
			1.5 => [PBTypes::DARK,PBTypes::PSYCHIC,PBTypes::COSMIC],
			1.3 => [PBTypes::FAIRY]},
		:TYPEMESSAGES => {
			...
			"The cosmos' background quivers!" => [PBTypes::COSMIC],},
		:FIELDCHANGE => {0 => [PBMoves::LIGHTTHATBURNSTHESKY]},
	...
	PBFields::NEWW => {
		...
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::AURORABEAM, PBMoves::SIGNALBEAM, PBMoves::FLASHCANNON, 
				...
				PBMoves::MENACINGMOONRAZEMAELSTROM,
             			PBMoves::COSMICRAY, PBMoves::DEJAVU, PBMoves::ASTRALSHOT,
              			PBMoves::COMETSHOWER, PBMoves::COSMICBARRAGE,
				PBMoves::GLACIATE, PBMoves::DYNAMAXCANNON, PBMoves::BEHEMOTHBLADE, PBMoves::BEHEMOTHBASH,
				PBMoves::ETERNABEAM, PBMoves::DRAGONENERGY, PBMoves::THUNDERCAGE, PBMoves::FREEZINGGLARE,
				PBMoves::FIERYWRATH, PBMoves::THUNDEROUSKICK, PBMoves::GLACIALLANCE, PBMoves::ASTRALBARRAGE,
				PBMoves::WILDBOLTSTORM, PBMoves::BLEAKWINDSTORM, PBMoves::SANDSEARSTORM, PBMoves::SPRINGTIDESTORM,
				PBMoves::COLLISIONCOURSE, PBMoves::ELECTRODRIFT, PBMoves::OCEANSWRATH, PBMoves::METALCRUNCHER,
				PBMoves::HYDROSTEAM, PBMoves::PSYBLADE, PBMoves::THUNDERCLAP, PBMoves::MIGHTYCLEAVE,
				PBMoves::TACHYONCUTTER, PBMoves::IVYCUDGEL, PBMoves::MALIGNANTCHAIN, PBMoves::LUMINACRASH,
				PBMoves::GEMSTONEGLIMMER, PBMoves::BLOODMOON, PBMoves::DRAGONDESCENT],
			2.0 => [PBMoves::VACUUMWAVE, PBMoves::DRACOMETEOR, PBMoves::METEORMASH, 
				PBMoves::MOONBLAST, PBMoves::COMETPUNCH, PBMoves::SWIFT, PBMoves::METEORBEAM,
				...
				PBMoves::BIGBANG2,
				PBMoves::LIGHTTHATBURNSTHESKY, PBMoves::METEORASSAULT],
			4.0 => [PBMoves::DOOMDUMMY],
			0.25 => [PBMoves::EARTHQUAKE, PBMoves::MAGNITUDE, PBMoves::BULLDOZE,
				PBMoves::SUBDUCTION],
			2.667 => [PBMoves::BIGBANG]},
		...
		:MOVEMESSAGES => {
			"The light shone through the infinite darkness!" => [PBMoves::AURORABEAM, 
				...
				PBMoves::LUMINACRASH, PBMoves::GEMSTONEGLIMMER],
			"The ethereal energy strengthened the attack!" => [PBMoves::PSYSTRIKE, PBMoves::AEROBLAST,
				...
				PBMoves::COLLISIONCOURSE, PBMoves::ELECTRODRIFT, PBMoves::OCEANSWRATH, PBMoves::METALCRUNCHER,
				PBMoves::HYDROSTEAM, PBMoves::PSYBLADE, PBMoves::THUNDERCLAP, PBMoves::MIGHTYCLEAVE,
				PBMoves::TACHYONCUTTER, PBMoves::IVYCUDGEL, PBMoves::MALIGNANTCHAIN, PBMoves::TERASTARSTORM,
				PBMoves::DRAGONDESCENT], 
			"The germinal matter amassed in the attack!" => [PBMoves::EARTHPOWER, PBMoves::POWERGEM, 
				PBMoves::ERUPTION, PBMoves::CONTINENTALCRUSH, PBMoves::TERASTARSTORM],
			"The astral energy boosted the attack!" => [PBMoves::VACUUMWAVE, PBMoves::DRACOMETEOR, 
				...
				PBMoves::HYPERSPACEHOLE, PBMoves::SPACIALREND, PBMoves::HYPERSPACEFURY, PBMoves::METEORBEAM,
				PBMoves::ANCIENTPOWER, PBMoves::FUTUREDUMMY, PBMoves::COSMICBARRAGE,
				PBMoves::METEORASSAULT],
			"A star came crashing down on {1}!" => [PBMoves::DOOMDUMMY], 
			"The cosmic energy strengthened the attack!" => [PBMoves::COSMICRAY, PBMoves::ASTRALSHOT,
				PBMoves::COMETSHOWER],
		        "Space-time is being distorted!" => [PBMoves::DEJAVU],
		        "The universe is reshaped!" => [PBMoves::BIGBANG2, PBMoves::BIGBANG],
			"{1} was swallowed up by the void!" => [PBMoves::BLACKHOLEECLIPSE],
			"The unformed land diffused the attack..." => [PBMoves::EARTHQUAKE, PBMoves::MAGNITUDE, PBMoves::BULLDOZE,
				PBMoves::SUBDUCTION],
			"The Blinding One shone down upon the New World!" => [PBMoves::LIGHTTHATBURNSTHESKY],
			"The blood red moon shone across the sky!" => [PBMoves::BLOODMOON]},
		:MOVETYPEMOD => {PBTypes::FIRE => [PBMoves::DOOMDUMMY]},
		:TYPEDAMAGEBOOST => {
			1.5 => [PBTypes::DARK],
			0.75 => [PBTypes::NUCLEAR]},
		:TYPEMESSAGES => {
			"Infinity boosted the attack!" => [PBTypes::DARK],
			"The radiation was dissipated through infinity..." => [PBTypes::NUCLEAR]},
	...
	PBFields::PSYCHICT => {
		...
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::HEX, PBMoves::MAGICALLEAF, PBMoves::MYSTICALFIRE, 
				...
				PBMoves::FOCUSBLAST, PBMoves::HIDDENPOWER, PBMoves::SECRETPOWER, PBMoves::LUSTERBEAM,
				PBMoves::FAENGRUSH]},
		...
		:MOVEMESSAGES => {
			"The psychic energy strengthened the attack!" => [PBMoves::HEX, PBMoves::MAGICALLEAF, 
				...
				PBMoves::FAENGRUSH]},
		:MOVETYPEMOD => {
			PBTypes::PSYCHIC => [PBMoves::STRENGTH, PBMoves::ANCIENTPOWER, PBMoves::DRAGONPULSE, PBMoves::WATERPULSE]},
	...
	# 43 Galactic Universe Field
	PBFields::GUFIELD => {
		:FIELDNAME => "Galactic Universe",
		:INTROMESSAGE => ["From the universe and the cosmos...","From the visions Team Galactic had in store...!"],
		:FIELDGRAPHICS =>  "GU",
		:SECRETPOWERANIM => PBMoves::ROAROFTIME,
		:NATUREMOVES => PBMoves::SPACIALREND,
		:MIMICRY => PBTypes::COSMIC, #RNG
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::AURORABEAM, PBMoves::ICEBEAM, PBMoves::ICESHARD, PBMoves::SIGNALBEAM, PBMoves::FLASHCANNON, 
				PBMoves::DAZZLINGGLEAM, PBMoves::FLAMETHROWER, PBMoves::MIRRORSHOT, PBMoves::PHOTONGEYSER, 
				PBMoves::PSYSTRIKE, PBMoves::POISONJAB, PBMoves::AEROBLAST, PBMoves::SACREDFIRE, PBMoves::MISTBALL, 
				PBMoves::LUSTERPURGE, PBMoves::SURF, PBMoves::ORIGINPULSE, PBMoves::PRECIPICEBLADES, 
				PBMoves::DRAGONASCENT, PBMoves::PSYCHOBOOST, PBMoves::ROAROFTIME, 
				PBMoves::MAGMASTORM, PBMoves::CRUSHGRIP, PBMoves::JUDGMENT, PBMoves::SEEDFLARE, 
				PBMoves::SHADOWFORCE, PBMoves::SEARINGSHOT, PBMoves::VCREATE, 
				PBMoves::SECRETSWORD, PBMoves::SACREDSWORD, PBMoves::RELICSONG, 
				PBMoves::FUSIONBOLT, PBMoves::AIRSLASH, PBMoves::FUSIONFLARE, PBMoves::ICEBURN, 
				PBMoves::FREEZESHOCK, PBMoves::BOLTSTRIKE, PBMoves::BLUEFLARE, 
				PBMoves::TECHNOBLAST, PBMoves::OBLIVIONWING, PBMoves::LANDSWRATH, 
				PBMoves::THOUSANDARROWS, PBMoves::THOUSANDWAVES, PBMoves::DIAMONDSTORM, 
				PBMoves::STEAMERUPTION, PBMoves::COREENFORCER, PBMoves::FLEURCANNON, 
				PBMoves::PRISMATICLASER, PBMoves::SUNSTEELSTRIKE, PBMoves::SPECTRALTHIEF, 
				PBMoves::MOONGEISTBEAM, PBMoves::MULTIATTACK, PBMoves::MINDBLOWN, PBMoves::THUNDER, 
				PBMoves::PLASMAFISTS, PBMoves::GENESISSUPERNOVA, PBMoves::SOULSTEALING7STARSTRIKE, PBMoves::SEARINGSUNRAZESMASH,
				PBMoves::MENACINGMOONRAZEMAELSTROM, PBMoves::COSMICBARRAGE],
			2.0 => [PBMoves::VACUUMWAVE, PBMoves::DRACOMETEOR, PBMoves::MOONBLAST, PBMoves::METEORBEAM, PBMoves::HYPERVOICE,
				PBMoves::HYPERSPACEHOLE, PBMoves::SPACIALREND, PBMoves::HYPERSPACEFURY, PBMoves::FUTUREDUMMY, PBMoves::BLACKHOLEECLIPSE, PBMoves::POWERGEM, PBMoves::EXTREMESPEED, PBMoves::DISCHARGE],
			2.5 => [PBMoves::DOOMDUMMY, PBMoves::ANCIENTPOWER, PBMoves::BIGBANG, PBMoves::BIGBANG2,
				PBMoves::METEORMASH,PBMoves::COMETPUNCH,PBMoves::SWIFT],
			0.1 => [PBMoves::EARTHQUAKE, PBMoves::MAGNITUDE, PBMoves::BULLDOZE, PBMoves::EARTHPOWER, PBMoves::ERUPTION, PBMoves::CONTINENTALCRUSH,
				PBMoves::SUBDUCTION]},
		:MOVEACCURACYBOOST => {100 => [PBMoves::DARKVOID]},
		:MOVEMESSAGES => {
			"The light shone through the never ending cosmos!" => [PBMoves::AURORABEAM, PBMoves::ICEBEAM, 
				PBMoves::SIGNALBEAM, PBMoves::FLASHCANNON, PBMoves::DAZZLINGGLEAM, PBMoves::DISCHARGE, 
				PBMoves::MIRRORSHOT, PBMoves::PHOTONGEYSER, PBMoves::BIGBANG, PBMoves::BIGBANG2, PBMoves::POWERGEM],
			"The entropy of the universe strengthened the attack!" => [PBMoves::PSYSTRIKE, PBMoves::FLAMETHROWER,
				PBMoves::ICESHARD, PBMoves::AEROBLAST, PBMoves::THUNDER,
				PBMoves::SACREDFIRE, PBMoves::MISTBALL, PBMoves::LUSTERPURGE, PBMoves::ORIGINPULSE, 
				PBMoves::PRECIPICEBLADES, PBMoves::DRAGONASCENT, PBMoves::PSYCHOBOOST, 
				PBMoves::ROAROFTIME, PBMoves::MAGMASTORM, PBMoves::CRUSHGRIP, PBMoves::JUDGMENT, 
				PBMoves::SEEDFLARE, PBMoves::SHADOWFORCE, PBMoves::SEARINGSHOT, PBMoves::VCREATE, 
				...
				PBMoves::MOONGEISTBEAM, PBMoves::MULTIATTACK, PBMoves::MINDBLOWN, 
				PBMoves::PLASMAFISTS, PBMoves::GENESISSUPERNOVA, PBMoves::SOULSTEALING7STARSTRIKE,
				PBMoves::SEARINGSUNRAZESMASH, PBMoves::MENACINGMOONRAZEMAELSTROM, PBMoves::BIGBANG, PBMoves::BIGBANG2],
			"The cosmic dust swooshed in and boosted the attack!" => [PBMoves::TAILWIND, PBMoves::VACUUMWAVE, 
				PBMoves::SURF, PBMoves::DRACOMETEOR, PBMoves::HYPERVOICE, 
				PBMoves::METEORMASH, PBMoves::MOONBLAST, PBMoves::COMETPUNCH, PBMoves::SWIFT, 
				PBMoves::HYPERSPACEHOLE, PBMoves::SPACIALREND, PBMoves::HYPERSPACEFURY, PBMoves::METEORBEAM,
				PBMoves::ANCIENTPOWER, PBMoves::FUTUREDUMMY, PBMoves::COSMICBARRAGE, PBMoves::BIGBANG, PBMoves::BIGBANG2],
			"A star came crashing down on {1}!" => [PBMoves::DOOMDUMMY, PBMoves::AIRSLASH, PBMoves::SWIFT, PBMoves::BIGBANG, PBMoves::BIGBANG2],
			"Like a comet crashing down on {1}!" => [PBMoves::EXTREMESPEED],
			"The universe collapsed, and thus was reborn!" => [PBMoves::BIGBANG, PBMoves::BIGBANG2],
			"{1} was swallowed up by the void!" => [PBMoves::BLACKHOLEECLIPSE],
			"The unformed land diffused the attack..." => [PBMoves::EARTHQUAKE, 
				PBMoves::MAGNITUDE, PBMoves::BULLDOZE, PBMoves::EARTHPOWER, PBMoves::ERUPTION, PBMoves::CONTINENTALCRUSH,
				PBMoves::SUBDUCTION]},
		:MOVETYPEMOD => {
			PBTypes::FIRE => [PBMoves::DOOMDUMMY],
			PBTypes::COSMIC => [PBMoves::METEORBEAM]},
		:TYPETYPEMOD => {PBTypes::COSMIC => [PBTypes::DARK,PBTypes::FAIRY,PBTypes::PSYCHIC]},
		:TYPEDAMAGEBOOST => {
			2.0 => [PBTypes::COSMIC],
			1.5 => [PBTypes::DARK,PBTypes::PSYCHIC],
			1.3 => [PBTypes::FAIRY]},
		:TYPEMESSAGES => {
			"The cosmos supercharged the attack!" => [PBTypes::PSYCHIC],
			"The energy of the stars boosted the attack!" => [PBTypes::FAIRY,PBTypes::DARK],
			"The quantum field boosted the attack!" => [PBTypes::COSMIC]},
		:FIELDCHANGE => {PBFields::STARLIGHTA => [PBMoves::GRAVITY, PBMoves::GEOMANCY]},
		:DONTCHANGEBACKUP => [PBMoves::GRAVITY],
		:CHANGEMESSAGE => {
			"A new planet was born!" => [PBMoves::GRAVITY],
			"A comet was generated!" => [PBMoves::GEOMANCY]},
		:STATUSMOVEBOOST => [PBMoves::TAILWIND, PBMoves::DARKVOID, PBMoves::HEARTSWAP, PBMoves::TRICKROOM, PBMoves::MAGICROOM, PBMoves::WONDERROOM, PBMoves::COSMICPOWER, PBMoves::FLASH, PBMoves::MOONLIGHT, PBMoves::NATURESMADNESS],
		:CHANGEEFFECTS => {},
		:SEED => PBItems::GRISEOUSORB,
		:SEEDEFFECT => PBEffects::Wish,
		:SEEDEFFECTVAL => 2,
		:SEEDEFFECTSTR => "{1} grew stronger!",
		:SEEDANIM => PBMoves::WISH,
		:SEEDSTATS => {PBStats::ATTACK => 1,PBStats::DEFENSE => 1,PBStats::SPEED => 1,PBStats::SPATK => 1,PBStats::SPDEF => 1}
		},
	# 44 Distortion World
	PBFields::DWORLD => {
		:FIELDNAME => "Distortion World",
		:INTROMESSAGE => ["Everything feels not right..","Like someone has been watching you.."],
		:FIELDGRAPHICS =>  "DW",
		:SECRETPOWERANIM => PBMoves::ROAROFTIME,
		:NATUREMOVES => PBMoves::SPACIALREND,
		:MIMICRY => PBTypes::COSMIC, #RNG
		:MOVEDAMAGEBOOST => {
			0.9 => [PBMoves::HYPERBEAM,PBMoves::GIGAIMPACT,PBMoves::ROAROFTIME,PBMoves::HYPERBEAM,],
			1.5 => [PBMoves::AURORABEAM, PBMoves::ICEBEAM, PBMoves::ICESHARD, PBMoves::SIGNALBEAM, PBMoves::FLASHCANNON, 
				PBMoves::DAZZLINGGLEAM, PBMoves::FLAMETHROWER, PBMoves::MIRRORSHOT, PBMoves::PHOTONGEYSER, 
				PBMoves::PSYSTRIKE, PBMoves::POISONJAB, PBMoves::AEROBLAST, PBMoves::SACREDFIRE, PBMoves::MISTBALL, 
				PBMoves::LUSTERPURGE, PBMoves::SURF, PBMoves::ORIGINPULSE, PBMoves::PRECIPICEBLADES, 
		...
		:TYPEDAMAGEBOOST => {
			2.0 => [PBTypes::COSMIC],
			1.5 => [PBTypes::DARK,PBTypes::PSYCHIC],
			1.3 => [PBTypes::FAIRY,PBTypes::ICE]},
		:TYPEMESSAGES => {
			"The cosmos supercharged the attack!" => [PBTypes::PSYCHIC],
			"The cold of the universe boosted the attack!" => [PBTypes::ICE],
			"The energy of the stars boosted the attack!" => [PBTypes::FAIRY,PBTypes::DARK],
			"The quantum field boosted the attack!" => [PBTypes::COSMIC]},
		:FIELDCHANGE => {PBFields::STARLIGHTA => [PBMoves::GRAVITY, PBMoves::GEOMANCY]},
		:DONTCHANGEBACKUP => [PBMoves::GRAVITY],
	...
	# 45 Fallout Field
	PBFields::FALLOUT => {
		:FIELDNAME => "Fallout Field",
		:INTROMESSAGE => "Radioactive energy fills the area!",
		:FIELDGRAPHICS =>  "Gamma",
		:SECRETPOWERANIM => PBMoves::HEATWAVE,
		:NATUREMOVES => PBMoves::NUCLEARWIND,
		:MIMICRY => PBTypes::NUCLEAR,
		:MOVEDAMAGEBOOST => {
			2.0 => [PBMoves::MISTYEXPLOSION]},
		:MOVEMESSAGES => {
			"The attack was contaminated!" => [PBMoves::WATERGUN, PBMoves::WATERPULSE, PBMoves::BUBBLE, PBMoves::BUBBLEBEAM,
				PBMoves::STEAMERUPTION, PBMoves::HYDROPUMP, PBMoves::BRINE, PBMoves::MUDDYWATER,
				PBMoves::WATERSPOUT, PBMoves::SPARKLINGARIA, PBMoves::SURF, PBMoves::WATERPLEDGE, PBMoves::WHIRLPOOL,
				PBMoves::HYDROSTEAM, PBMoves::MISTYEXPLOSION, PBMoves::SPLISHYSPLASH, PBMoves::BOUNCYBUBBLE]},
		:MOVETYPEMOD => {
			PBTypes::NUCLEAR => [PBMoves::OMINOUSWIND, PBMoves::HEATWAVE, PBMoves::GUST, PBMoves::ICYWIND,
				PBMoves::RAZORWIND, PBMoves::FAIRYWIND, PBMoves::SILVERWIND, PBMoves::TWISTER, PBMoves::EXPLOSION,
				PBMoves::SELFDESTRUCT, PBMoves::WATERGUN, PBMoves::WATERPULSE, PBMoves::BUBBLE, PBMoves::BUBBLEBEAM,
				PBMoves::STEAMERUPTION, PBMoves::HYDROPUMP, PBMoves::BRINE, PBMoves::MUDDYWATER, 
				PBMoves::WATERSPOUT, PBMoves::SPARKLINGARIA, PBMoves::SURF, PBMoves::WATERPLEDGE, PBMoves::WHIRLPOOL,
				PBMoves::HYDROSTEAM, PBMoves::MISTYEXPLOSION, PBMoves::SPLISHYSPLASH, PBMoves::BOUNCYBUBBLE]},
		:TYPEDAMAGEBOOST => {1.5 => [PBTypes::NUCLEAR,PBTypes::POISON]},
		:TYPEMESSAGES => {
			"The field amplified the attack!" => [PBTypes::POISON],
			"The radiation boosted the attack!" => [PBTypes::NUCLEAR]},
		:TYPECONDITION => {},
		:TYPETYPEMOD => {PBTypes::NUCLEAR => [PBTypes::POISON]},
		:FIELDCHANGE => {PBFields::CORROSIVEF => [PBMoves::ROAROFTIME, PBMoves::PURIFY, PBMoves::CLEARSMOG, PBMoves::SEEDFLARE]},
		:CHANGEMESSAGE => {"Some radiation  was slightly  cleared!" => [PBMoves::ROAROFTIME, PBMoves::PURIFY, PBMoves::CLEARSMOG, PBMoves::SEEDFLARE]},
		:CHANGEEFFECTS => {},
		:SEED => PBItems::ELEMENTALSEED,
		:SEEDEFFECT => PBEffects::GastroAcid,
		:SEEDEFFECTVAL => true,
		:SEEDEFFECTSTR => "{1}'s ability was suppressed!",
		:SEEDANIM => PBMoves::GASTROACID,
		:SEEDSTATS => {PBStats::SPDEF => 1, PBStats::DEFENSE => 1}
	}
}
