	...
	PBFields::BIGTOPA => {
		...
		:MOVEDAMAGEBOOST => {
			...
			1.5 => [PBMoves::VINEWHIP, PBMoves::POWERWHIP, PBMoves::FIRELASH, 
				...
				PBMoves::AURAWHEEL, PBMoves::AURAWHEELMINUS, PBMoves::AQUASTEP, PBMoves::TRIPLEDIVE,
	...
	PBFields::NEWW => {
		...
		:MOVEDAMAGEBOOST => {
			...
			2.0 => [PBMoves::VACUUMWAVE, PBMoves::DRACOMETEOR, PBMoves::METEORMASH, 
				...
				PBMoves::BIGBANG2,
				PBMoves::LIGHTTHATBURNSTHESKY, PBMoves::METEORASSAULT, PBMoves::],
			4.0 => [PBMoves::DOOMDUMMY],
			0.25 => [PBMoves::EARTHQUAKE, PBMoves::MAGNITUDE, PBMoves::BULLDOZE,
				PBMoves::SUBDUCTION],
