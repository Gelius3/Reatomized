FIELDEFFECTS = {
	...
	PBFields::MISTYT => {
		...
		:MOVEDAMAGEBOOST => {
			...
			1.5 => [PBMoves::FAIRYWIND, PBMoves::MYSTICALFIRE, PBMoves::MOONBLAST, 
				...
				PBMoves::SPRINGTIDESTORM, PBMoves::SPARKLYSWIRL],
	...
	PBFields::DARKCRYSTALC => {
		...
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::DARKPULSE, PBMoves::NIGHTDAZE, PBMoves::NIGHTSLASH,
				...
				PBMoves::COSMICBARRAGE, PBMoves::MIDNIGHTPHOTOSYNTHESIS, PBMoves::BLOODMOON,
		...
		:MOVEMESSAGES => {
			...
			"The darkness strengthened the attack!"	=> [PBMoves::SHADOWBALL, PBMoves::SHADOWPUNCH, 
				...
				PBMoves::MENACINGMOONRAZEMAELSTROM, PBMoves::CEASELESSEDGE,
				PBMoves::AURAWHEELMINUS, PBMoves::FIERYWRATH, PBMoves::WEAKENINGJUMPSCARE], 
	...
	PBFields::BIGTOPA => {
		...
		:MOVEDAMAGEBOOST => {
			...
			1.5 => [PBMoves::VINEWHIP, PBMoves::POWERWHIP, PBMoves::FIRELASH, 
				...
				PBMoves::ORDERUP, PBMoves::METALWHIP, PBMoves::IONICWHIPLASH,
				PBMoves::DRUMBEATING],
		...
		:MOVEMESSAGES => {
			"Back, foul beast!" => [PBMoves::VINEWHIP, PBMoves::POWERWHIP, PBMoves::FIRELASH,
				PBMoves::METALWHIP, PBMoves::IONICWHIPLASH], 
	...
	PBFields::BURNINGF => {
		...
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::SMOG, PBMoves::CLEARSMOG,
				PBMoves::SCORCHINGSANDS, PBMoves::FIERYWRATH],
	...
	PBFields::RAINBOWF => {
		...
		:MOVEDAMAGEBOOST => {
			...
			0.5 => [PBMoves::DARKPULSE, PBMoves::SHADOWBALL, PBMoves::NIGHTDAZE, PBMoves::NEVERENDINGNIGHTMARE,
				...
				PBMoves::DRAINLIFE, PBMoves::BITTERBLADE]},
		:MOVEMESSAGES => {
	...
	PBFields::CORROSIVEMISTF => {
		...
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::BUBBLEBEAM, PBMoves::ACIDSPRAY, PBMoves::BUBBLE, PBMoves::SMOG, 
				...
				PBMoves::APPLEACID, PBMoves::STRANGESTEAM,
				PBMoves::SPARKLYSWIRL],
			2.0 => [PBMoves::MISTYEXPLOSION]},
		...
		:MOVEMESSAGES => {
			"The poison strengthened the attack!" => [PBMoves::BUBBLEBEAM, PBMoves::ACIDSPRAY, 
				...
				PBMoves::APPLEACID, PBMoves::STRANGESTEAM,
				PBMoves::SPARKLYSWIRL],
			"The poisonous mist strengthened the attack!" => [PBMoves::MISTYTERRAIN]},
		:MOVETYPEMOD => {
	...
	PBFields::DESERTF => {
		...
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::NEEDLEARM, PBMoves::PINMISSILE, PBMoves::DIG, PBMoves::SANDTOMB, 
				...
				PBMoves::SCORCHINGSANDS, PBMoves::SANDSEARSTORM],
	...
	PBFields::ICYF => {
		...
		:MOVEDAMAGEBOOST => { 
			...
			1.5 => [PBMoves::BITTERMALICE, PBMoves::FREEZINGGLARE, PBMoves::BLEAKWINDSTORM],
		...
		:MOVEMESSAGES => {
			...
			"The cold strengthened the attack!" => [PBMoves::BITTERMALICE, PBMoves::FREEZINGGLARE, PBMoves::BLEAKWINDSTORM,
	...
	PBFields::FORESTF => {
		...
		:MOVEDAMAGEBOOST => {
			...
			1.5 => PBFields::SLASHMOVES + [PBMoves::ATTACKORDER, PBMoves::ELECTROWEB, PBMoves::SKITTERSMACK, PBMoves::DRUMBEATING, PBMoves::POUNCE,
				PBMoves::BREAKINGSWIPE, PBMoves::FORESTFRENZY],
		...
		:MOVEMESSAGES => {
			...
			"The target was cut down to size!" => PBFields::SLASHMOVES + [PBMoves::BREAKINGSWIPE],
	...
	PBFields::SHORTCIRCUITF => {
		...
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::DAZZLINGGLEAM, PBMoves::SURF, PBMoves::MUDDYWATER, PBMoves::MAGNETBOMB, PBMoves::INFERNALPARADE,
				...
				PBMoves::WILDBOLTSTORM, PBMoves::IONICWHIPLASH, PBMoves::LUMINACRASH,
		...
		:MOVEMESSAGES => {
			...
			"The darkness strengthened the attack!" => [PBMoves::DARKPULSE, PBMoves::NIGHTDAZE, 
				...
				PBMoves::FIERYWRATH, PBMoves::WEAKENINGJUMPSCARE],
			"{1} couldn't consume much light..." => [PBMoves::LIGHTTHATBURNSTHESKY]},
		:MOVETYPEMOD => {
	...
	PBFields::ASHENB => {
		...
		:MOVEDAMAGEBOOST => {
			1.5 => [PBMoves::HIDDENPOWER, PBMoves::STRENGTH, PBMoves::LANDSWRATH, 
				...
				PBMoves::CORALBREAK, PBMoves::SHELLTRAP],
		...
		:MOVEMESSAGES => {
			...
			"Surf's up!" => [PBMoves::SURF, PBMoves::MUDDYWATER,
				PBMoves::WAVECRASH, PBMoves::CORALBREAK],
	...
	PBFields::STARLIGHTA => {
		...
		:MOVEMESSAGES => {
			...
			"The universe has started once again!" => [PBMoves::BIGBANG]},
		:MOVETYPEMOD => {
	...
	PBFields::NEWW => {
		...
		:MOVEMESSAGES => {
		    ...
		    "The universe is reshaped!" => [PBMoves::BIGBANG],
			"{1} was swallowed up by the void!" => [PBMoves::BLACKHOLEECLIPSE],
			"The unformed land diffused the attack..." => [PBMoves::EARTHQUAKE, PBMoves::MAGNITUDE, PBMoves::BULLDOZE, PBMoves::SUBDUCTION],
	...
	PBFields::GUFIELD => {
		...
		:MOVEDAMAGEBOOST => {
			...
			2.5 => [PBMoves::DOOMDUMMY, PBMoves::ANCIENTPOWER, PBMoves::BIGBANG,
		...
		:MOVEMESSAGES => {
			"The light shone through the never ending cosmos!" => [PBMoves::AURORABEAM, PBMoves::ICEBEAM, 
				...
				PBMoves::MIRRORSHOT, PBMoves::PHOTONGEYSER, PBMoves::BIGBANG, PBMoves::POWERGEM],
			"The entropy of the universe strengthened the attack!" => [PBMoves::PSYSTRIKE, PBMoves::FLAMETHROWER,
				...
				PBMoves::MOONGEISTBEAM, PBMoves::MULTIATTACK, PBMoves::MINDBLOWN, 
				PBMoves::PLASMAFISTS, PBMoves::GENESISSUPERNOVA, PBMoves::SOULSTEALING7STARSTRIKE,
				PBMoves::SEARINGSUNRAZESMASH, PBMoves::MENACINGMOONRAZEMAELSTROM, PBMoves::BIGBANG],
			"The cosmic dust swooshed in and boosted the attack!" => [PBMoves::TAILWIND, PBMoves::VACUUMWAVE, 
				...
				PBMoves::METEORMASH, PBMoves::MOONBLAST, PBMoves::COMETPUNCH, PBMoves::SWIFT, 
				PBMoves::HYPERSPACEHOLE, PBMoves::SPACIALREND, PBMoves::HYPERSPACEFURY, PBMoves::METEORBEAM,
				PBMoves::ANCIENTPOWER, PBMoves::FUTUREDUMMY, PBMoves::COSMICBARRAGE, PBMoves::BIGBANG],
			"A star came crashing down on {1}!" => [PBMoves::DOOMDUMMY, PBMoves::AIRSLASH, PBMoves::SWIFT, PBMoves::BIGBANG],
			"Like a comet crashing down on {1}!" => [PBMoves::EXTREMESPEED],
			"The universe collapsed, and thus was reborn!" => [PBMoves::BIGBANG],
			"{1} was swallowed up by the void!" => [PBMoves::BLACKHOLEECLIPSE],
