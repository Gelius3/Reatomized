...
class PokeBattle_Battle
  ...
  def testAllBattlesDoubles(canlose)
	...
	def pbAttackPhaseTEST
      ...
      @battlers[i].turncount+=1 if !@battlers[i].isFainted? && (@battlers[i].ability==PBAbilities::SLOWSTART || @battlers[i].ability==PBAbilities::QUICKSTART) && @field.effect==PBFields::ELECTRICT
