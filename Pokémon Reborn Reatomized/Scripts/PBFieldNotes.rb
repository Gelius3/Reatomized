...
def pbCompileFieldNotes
  ...
  #Electric Field
    ...
    PBFieldNote.new(1,"Gulp Missile is always Pikachu."),
    ...
    PBFieldNote.new(1,"Transistor power boost <icon=fieldChange> <c=green>x2</c> "),
  ...
  #Grassy Terrain
    ...
    PBFieldNote.new(2,"Cotton Down's effect <icon=fieldUp> "),
  ...
  #Dark Crystal Cavern
    ...
    PBFieldNote.new(4,"Prism Armor <c=green>lowers damage</c> x0.75"),
  ...
  #Big Top Arena
    ...
    PBFieldNote.new(6,"<c=orange>Striker Moves</c> roll <c=green>high</c> when . . .", "...when the attacker has one of these abilities: Sheer Force, Guts, Huge Power, Punk Rock, Pure Power"),
    ...
    PBFieldNote.new(6,"Pay Day and Make It Rain BP <icon=fieldUp> <c=green>x2</c> and payout <icon=fieldUp> "),
PBFieldNote.new(6,"Certain attacks <icon=fieldUp> <c=green>x1.2</c> . . .", feToStringName(PBFields::BIGTOPA, :MOVEDAMAGEBOOST, 1.2)),
    ...
    PBFieldNote.new(6,"Accuracy of Sing, Triple Kick and Triple Axel <icon=fieldChange> <c=green>100</c> "),
  ...
  #Burning Field
    ...
    PBFieldNote.new(7,"<c=green>Activates</c> Steam Engine"),
  ...
  #Rainbow Field
    ...
    PBFieldNote.new(9,"Prism Armor <c=green>lowers damage</c> x0.75"),
  ...
  #Desert Field
    ...
    PBFieldNote.new(12,"Sand Spit stirs up <c=orange>sand</c> . . ."," ...lowering all active Pokémon's Accuracy."),
  ...
  #Icy Field
    ...
    PBFieldNote.new(13,"<icon=fieldFire> attacks <icon=fieldDown> <c=red>x0.5</c> "),
...
PBFieldNote.new(13,"Snipe Shot <icon=fieldPlus> <icon=fieldIce> "),
...
PBFieldNote.new(13,"Certain attacks <icon=fieldChange> <c=green>no charge turn</c> ","Freeze Shock, Ice Burn"), 
...
PBFieldNote.new(13,"Mountain Gale's Accuracy <icon=fieldChange> <c=green>100</c> "),
  ...
  #Super-Heated Field
    ...
    PBFieldNote.new(16,"<c=green>Activates</c> Steam Engine"),
  ...
  #Factory Field
    ...
    PBFieldNote.new(17,"Troubleshooter applies from BP <c=green>40</c> "),
    PBFieldNote.new(17,"Gulp Missile is always Pikachu."),
    ...
    PBFieldNote.new(17,"Becomes <c=orange>Short-Circuit</c> when . . .","...when #{feToStringName(PBFields::FACTORYF, :FIELDCHANGE, PBFields::SHORTCIRCUITF)} is used. Discharge and Rising Voltage additionally can alternate between the Short-Circuit and Factory Fields for each instance of damage in Double Battles."),
    ...
    PBFieldNote.new(17,"Transistor power boost <icon=fieldChange> <c=green>x2</c> "),
  ...
  #Short-Circuit Field
    ...
    PBFieldNote.new(18,"Becomes <c=orange>Factory Field</c> when . . .","...when #{feToStringName(PBFields::SHORTCIRCUITF, :FIELDCHANGE, PBFields::FACTORYF)} is used. Discharge and Rising Voltage additionally can alternate between the Short-Circuit and Factory Fields for each instance of damage in Double Battles."),
...
PBFieldNote.new(18,"Steel Beam <icon=fieldPlus> <icon=fieldElectric> "),
    PBFieldNote.new(18,"Galvanize power boost <icon=fieldChange> <c=green>x2</c> "),
    PBFieldNote.new(18,"Transistor power boost <icon=fieldChange> <c=green>x2</c> "),
  ...
  #Ashen Beach
    ...
    PBFieldNote.new(20,"Sand Spit stirs up <c=orange>ash</c> . . ."," ...lowering all active Pokémon's Accuracy."),
    ...
    PBFieldNote.new(20,"Certain stat moves' effect <icon=fieldUp> . . .","Calm Mind, Coaching, Kinesis, Meditate, Sand Attack"),
  ...
  #Water Surface
    ...
    PBFieldNote.new(21,"Propeller Tail doubles Speed"),
    PBFieldNote.new(21,"Gulp Missile is always Arrokuda"),
  ...
  #Underwater
    ...
    PBFieldNote.new(22,"<c=green>Immunity</c> to <c=orange>field damage</c> when . . .","...when the abilities Magic Guard or Swift Swim or Water Absorb are active."),
    ...
    PBFieldNote.new(22,"Propeller Tail doubles Speed."),
    PBFieldNote.new(22,"Gulp Missile is always Arrokuda."),
  ...
  #Glitch Field
    ...
    PBFieldNote.new(24,"Type attacks <icon=fieldChange> always Physical . . .","Normal, Fighting, Poison, Ground, Flying, Bug, Rock, Ghost, Nuclear."),
    PBFieldNote.new(24,"Type attacks <icon=fieldChange> always Special . . .","Fire, Water, Grass, Electric, Ice, Psychic, Dragon, Cosmic."),
    PBFieldNote.new(24,"<c=red>Prevents</c> generated Fields"),
    ...
    PBFieldNote.new(24,"<icon=fieldNuclear>, <icon=fieldCosmic> moves <icon=fieldChange> <icon=fieldNormal> "),
  ...
  #Crystal Cavern
    ...
    PBFieldNote.new(25,"Prism Armor <c=green>lowers damage</c> x0.75"),
...
PBFieldNote.new(27,"Mountain Gale <icon=fieldPlus> <icon=fieldRock>"),
...
PBFieldNote.new(28,"Galarian-Zen Mode <c=green>always active</c> "),
...
PBFieldNote.new(28,"Mountain Gale's Accuracy <icon=fieldChange> <c=green>100</c> "),
  ...
  #Mirror Field
    ...
    PBFieldNote.new(30,"Certain abilities <c=green>boost</c> Evasion . . .","Color Change, Ice Scales, Illusion, Magic Bounce, Sand Veil, Snow Cloak, and Tangled Feet boost Evasion when switched in."),
  ...
  #Fairy Tale Field
    ...
    PBFieldNote.new(31,"Certain abilities <icon=fieldPlus> Defense <icon=fieldUp> . . .","Battle Armor, Mirror Armor, Power of Alchemy and Shell Armor boost Defense upon switching in."),
    PBFieldNote.new(31,"Certain abilities <icon=fieldPlus> Sp.Def <icon=fieldUp> . . .","Magic Guard, Magic Bounce, Mirror Armor and Power of Alchemy boost Sp.Def upon switching in."),
  ...
  #Dragon's Den
    ...
    PBFieldNote.new(32,"<icon=fieldWater> attacks <icon=fieldDown> <c=red>x0.5</c> "),
    PBFieldNote.new(32,"<icon=fieldIce> attacks <icon=fieldDown> <c=red>x0.5</c> "),
    ...
    PBFieldNote.new(32,"Dragons Maw power boost <icon=fieldChange> <c=green>x2</c> "),
...
PBFieldNote.new(34,"Meteor Beam <icon=fieldPlus> <icon=fieldDark> "),
  ...
  #Psychic Field
    ...
    PBFieldNote.new(37,"Telepathy and Forewarn <c=green>boosts</c> Speed <c=green>x2</c> "),
  ...
  #Galactic Univerese
   # PBFieldNote.new(37,"<c=orange>\"#{FIELDEFFECTS.dig(PBFields::GUFIELD, :INTROMESSAGE)}\"</c> "),
  #Distortion World
   # PBFieldNote.new(37,"<c=orange>\"#{FIELDEFFECTS.dig(PBFields::DWORLD, :INTROMESSAGE)}\"</c> "),
#Fallout Field
PBFieldNote.new(45,"<c=orange>\"#{FIELDEFFECTS.dig(PBFields::FALLOUT, :INTROMESSAGE)}\"</c> "),
PBFieldNote.new(45,"End of turn <icon=fieldNuclear> <c=orange>damage</c> when . . .","...when Pokemon is weak to Nuclear type."),
PBFieldNote.new(45,"<icon=fieldNuclear> attacks <icon=fieldUp> <c=green>x1.5</c> "),
PBFieldNote.new(45,"<icon=fieldPoison> attacks <icon=fieldUp> <c=green>x1.5</c> "),
PBFieldNote.new(45,"<c=green>Activates</c> Expunge"),
PBFieldNote.new(45,"The type chart is <c=orange>altered</c> . . .","Nuclear deals neutral damage to Cosmic types"),
PBFieldNote.new(45,"<c=green>Activates</c> Toxic Boost and Flare Boost"),
PBFieldNote.new(45,"<icon=fieldPoison> attacks <icon=fieldPlus> <icon=fieldNuclear> damage"),
PBFieldNote.new(45,"Certain attacks <icon=fieldPlus> <icon=fieldNuclear> . . .","#{feToStringName(PBFields::FALLOUT, :MOVETYPEMOD, PBTypes::NUCLEAR)}"),
PBFieldNote.new(45,"Becomes a <c=orange>Corrosive Field</c> when . . .","...when Roar of Time, Purify, Clear Smog or Seed Flare is used."),
PBFieldNote.new(45,"Nature Power <icon=fieldChange> #{feToStringName(PBFields::FALLOUT, :NATUREMOVES)}"),
PBFieldNote.new(45,"Camouflage <icon=fieldChange> <icon=field#{PBTypes.getName(FIELDEFFECTS.dig(PBFields::FALLOUT, :MIMICRY))}> "),
PBFieldNote.new(45,"Secret Power <icon=fieldChange> <icon=fieldBurn> "),
PBFieldNote.new(45,"Activates <c=orange>Elemental Seed</c>. . .","Boosts Defensive stats and applies Gastro Acid to the user.")
  ]
